...
and
DAGCircuit.compose
had, in some cases, incorrectly translated conditional gates if the input circuit contained more than one
ClassicalRegister
...
DAGCircuit
class so that global phase can be tracked when converting between
QuantumCircuit
and
DAGCircuit
.
